        ...
        document.addEventListener("DOMContentLoaded", () => {
          ...
          if (isFirstVisit) {
            showNotification("Welcome to Byte Bistro! Enjoy a special 15% discount on your first order.", "success")
          }
        })
        ...
        function initializeMenu() {
          menuItems = [
            ...
            },
            {
              ...
              price: 180,
              image:
                "https://kalejunkie.com/wp-content/uploads/2022/11/KALEJUNKIE-CHEESEY-GARLIC-PULLED-BREAD-3.jpg",
              category: "starters",
            },
            {
              id: 3,
          ...
          vipMenuItems = [
            ...
            },
            {
              ...
              price: 850,
              image:
                "https://images.unsplash.com/photo-1633964913295-ceb43826e7c1?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80",
              category: "vip",
            },
            {
              id: 103,
        ...
        function updateTimeDisplay() {
          ...
          if (hour >= 8 && hour < 11) {
            ...
            timeMessage = "Welcome to Byte Bistro! Explore our menu."
          }
